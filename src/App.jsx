...
/**
 * 퀸즈 유니버설 통합 솔루션 (v44.0 - Master Edition)
 * - 모든 외부 링크의 마크다운 기호([]) 제거 완료
 * - 내비게이션 및 모듈 전환 로직 최적화
      ...
      <aside className="w-72 bg-slate-950/95 border-r border-slate-800 flex flex-col p-8 shrink-0 z-50 shadow-2xl">
        ...
        <div className="mt-auto p-5 bg-slate-900/40 rounded-3xl border border-slate-800/50 text-center">
            <div className="flex items-center justify-center gap-2 text-[10px] font-black text-emerald-500 uppercase tracking-widest">
               <ShieldCheck className="w-4 h-4" /> Hub Active v44.0
            </div>
        </div>
      </aside>
        ...
        {activeModule === "Dashboard" && (
          <div className="space-y-16 animate-in fade-in duration-1000">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
               {/* 아틀리에 링크 */}
               <a href="https://queensmiracle.com" target="_blank" rel="noopener noreferrer" className="bg-slate-900/50 p-10 rounded-[4rem] border border-slate-800 shadow-2xl group hover:border-blue-500/50 transition-all hover:-translate-y-3">
               ...
               {/* 퀸즈몰 링크 */}
               <a href="https://queensmall.kr" target="_blank" rel="noopener noreferrer" className="bg-slate-900/50 p-10 rounded-[4rem] border border-slate-800 shadow-2xl group hover:border-pink-500/50 transition-all hover:-translate-y-3">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
               <div className="bg-slate-900/30 p-16 rounded-[5rem] border border-slate-800 shadow-2xl">
                  ...
                  <p className="text-slate-400 leading-relaxed text-lg italic">
                     ...
                     아틀리에 홈페이지와 쇼핑몰을 버튼 하나로 연결하여 통합 브랜드 경험을 제공합니다.
                  </p>
               </div>
               <div className="bg-slate-900/30 p-16 rounded-[5rem] border border-slate-800 shadow-2xl">
